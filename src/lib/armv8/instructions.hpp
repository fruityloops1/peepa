...
#define _ACCESSOR_BODY(name)                                                                                           \
    constexpr InstType _ACCESSOR_GETTER_NAME(name)() const { return BitsOf<_ACCESSOR_MASK_NAME(name)>(); }             \
    constexpr void _ACCESSOR_SETTER_NAME(name)(InstType val) { SetBits<_ACCESSOR_MASK_NAME(name)>(val); }
