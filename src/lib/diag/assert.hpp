...
#define EXL_CALL_ASSERT_FAIL_IMPL(cond, ...)                                                                           \
    ::exl::diag::AssertionFailureImpl(__FILE__, __LINE__, __PRETTY_FUNCTION__, cond, 0, ##__VA_ARGS__)
#define EXL_CALL_ABORT_IMPL(cond, value, ...)                                                                          \
    ::exl::diag::AbortImpl(__FILE__, __LINE__, __PRETTY_FUNCTION__, cond, value, ##__VA_ARGS__)
