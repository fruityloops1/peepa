...
add_definitions(-DSWITCH -DNNSDK -D__SWITCH__ -D__RTLD_6XX__)

set(ARCH "-march=armv8-a+crc+crypto -mtune=cortex-a57 -mtp=soft -fpic -fvisibility=hidden")

set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -g -Wall -O0 -ffunction-sections -fdata-sections ${ARCH}" CACHE STRING "C flags")
